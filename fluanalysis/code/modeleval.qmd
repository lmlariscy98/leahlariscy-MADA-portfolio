...
# This Section added my Nathan Greenslit
...
This will run a linear regression on the flu data, predicting body temperature [using all other variables]{.ul} that we kept.
...
### Model assessment on [training]{.ul} data: RMSE and Rsq
...
### Model assessment on [testing]{.ul} data:  RMSE and Rsq
...
### Model assessment on [training]{.ul} data
...
### Model assessment on [testing]{.ul} data
